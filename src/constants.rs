...
pub const DEFAULT_QUEUE_TAGS: [&str; 3] = ["tracktitle", "artist", "album"];
pub const DEFAULT_LIBRARY_TAGS: [&str; 1] = ["tracktitle"];
pub const DEFAULT_PLAYLIST_TAGS: [&str; 2] = ["artist", "tracktitle"];
